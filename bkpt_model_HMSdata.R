#===============================================================
#Project: Assessing temporal patterns of the migratory raptor assemblage structure at HMS
#Objective: Fitting the random change point model to a time-series data
#Notes: 
#1.modified from S.Brilleman et al. 2017 R code: https://github.com/sambrilleman/2017-Epidemiology/blob/master/R_example_fitting_the_random_change_point_model_in_Stan.R
#2.removed BLVU (1934-1984) and TUVU (1969-1982), WWII(1942-1945) missing years#########
#===============================================================  
...
#priors: Cauchy, smae as original breakpoint model
...
#example 1:modelled data for AMKE###########
...
lines(mean_sp1~c(1:73),col="black",lwd=3)
amke=subset(hms, species=="AMKE")
points(amke$count, pch=21, cex=1, col="red", bg="red")
